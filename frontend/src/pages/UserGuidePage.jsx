...
/**
 * AI 커리어 챗봇의 사용 방법을 안내하는 페이지 컴포넌트입니다.
 * 챗봇 소개, 주요 기능별 사용법, 문의 및 도움말 섹션으로 구성됩니다.
 */
function UserGuidePage() {
    return (
        // 페이지 전체 컨테이너: 배경색 및 기본 텍스트 색상 설정
        <div className="min-h-screen bg-gray-50 p-6 dark:bg-gray-800 text-gray-900 dark:text-gray-100">
            {/* 가이드 내용 컨테이너: 배경색, 그림자, 패딩, 라운드 처리 */}
            <div className="container mx-auto px-4 py-8 bg-white rounded-lg shadow-md dark:bg-gray-700">
                ...
                <section className="mb-10">
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed mb-4 dark:text-gray-300">
                        AI 커리어 챗봇은 생성형 AI 기술을 활용하여 구직자 및 이직자분들의 성공적인 취업을 돕기 위해 개발되었습니다.
                        이력서 분석부터 면접 준비까지, 당신의 커리어 여정에 필요한 맞춤형 가이드를 제공합니다.
                    </p>
                ...
                <section className="mb-10">
                    ...
                    <div className="bg-gray-50 p-6 rounded-lg mb-6 shadow-sm dark:bg-gray-800">
                        ...
                        <ul className="list-disc list-inside text-gray-700 mt-2 ml-4 dark:text-gray-300">
                            <li><strong>회원가입:</strong> 로그인 페이지 하단의 '회원가입' 링크 클릭 &rarr; 아이디, 비밀번호 입력 후 가입.</li>
                            <li><strong>로그인:</strong> 로그인 페이지에서 등록한 아이디, 비밀번호 입력 &rarr; '로그인' 버튼 클릭.</li>
                        </ul>
                    </div>
                    ...
                    <div className="bg-gray-50 p-6 rounded-lg mb-6 shadow-sm dark:bg-gray-800">
                        ...
                        <ul className="list-disc list-inside text-gray-700 mt-2 ml-4 dark:text-gray-300">
                            ...
                            <li><strong>최근 분석 기록:</strong> 이전 대화 및 분석 기록들을 확인할 수 있는 페이지로 이동합니다.</li>
                        </ul>
                    </div>
                    ...
                    <div className="bg-gray-50 p-6 rounded-lg mb-6 shadow-sm dark:bg-gray-800">
                        ...
                        <ul className="list-disc list-inside text-gray-700 mt-2 ml-4 dark:text-gray-300">
                            <li><strong>파일 업로드:</strong> PDF 또는 Word(doc, docx), TXT 형식의 이력서 파일을 첨부합니다.</li>
                    ...
                    <div className="bg-gray-50 p-6 rounded-lg mb-6 shadow-sm dark:bg-gray-800">
                        ...
                        <ul className="list-disc list-inside text-gray-700 mt-2 ml-4 dark:text-gray-300">
                            ...
                            <li><strong>답변 입력/피드백:</strong> 각 질문에 답변을 입력하고 AI 피드백을 받아 답변을 개선할 수 있습니다.</li>
                        </ul>
                    </div>
                </section>
                ...
                <section className="mb-6">
                    ...
                    <p className="text-gray-700 leading-relaxed dark:text-gray-300">
                        챗봇 사용 중 궁금한 점이나 문제가 발생하면 언제든지 문의해 주세요. (현재는 데모 목적으로 문의 채널이 제공되지 않습니다. 정식 서비스 시 추가 예정)
                    </p>
                </section>
